...
least one backup location available. The current v0.59.0 release publishes Linux x86_64, Windows <!-- x-release-please-version -->
...
1. **Download Cortana Desktop.** Open the [latest GitHub release](https://github.com/adea-ai/cortana/releases/latest)
   ...
   **v0.59.0**; <!-- x-release-please-version --> [Release history](releases.md) records its verifier state and remaining trust gate.
